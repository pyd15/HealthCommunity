...
public class SelfAppointmentActivity extends AppCompatActivity {
    ...
    private String[] hospital_big_department,hospital_internal,hospital_obstetrics_gynecology
            ,hospital_orthopedics,hospital_oncology,hospital_surgery,hospital_subsidiary;
