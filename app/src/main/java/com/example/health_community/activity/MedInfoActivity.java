...
public class MedInfoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Medicine medicine = (Medicine) getIntent().getSerializableExtra(Constant.MEDINCINE_INFO);
        ...
        ArrayList<String> imageList = getIntent().getStringArrayListExtra(Constant.IMAGE_LIST);
        ...
        medicineInfoFragment.refresh(getApplicationContext(),nameList,imageList);
